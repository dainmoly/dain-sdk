import { WebSocketClientAccountSubscriber } from "./webSocketClientAccountSubscriber";
...
export class gprcClientAccountSubscriber extends WebSocketClientAccountSubscriber {
