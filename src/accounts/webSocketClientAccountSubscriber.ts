...
export class WebSocketClientAccountSubscriber
  implements DainClientAccountSubscriber
{
  ...
  async setInitialData(): Promise<void> {
    ...
    if (!this.initialPerpMarketAccountData) {
      ...
      const perpMarketAccountInfos =
        await connection.getMultipleAccountsInfo(perpMarketPublicKeys);
      this.initialPerpMarketAccountData = new Map(
    ...
    if (!this.initialSpotMarketAccountData) {
      ...
      const spotMarketAccountInfos =
        await connection.getMultipleAccountsInfo(spotMarketPublicKeys);
      this.initialSpotMarketAccountData = new Map(
